...
| <a name="input_deploy_keys"></a> [deploy\_keys](#input\_deploy\_keys) | The list of auto-generated deploy keys of the repository (key: key\_title, value: true if can write) | `map(bool)` | `{}` | no |
