...
| <a name="input_rename_to"></a> [rename\_to](#input\_rename\_to) | (Optional) New name for this repository (useful for renaming, but not changing the name of the resource) | `string` | `null` | no |
