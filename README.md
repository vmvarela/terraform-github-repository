...
| <a name="input_deploy_keys_path"></a> [deploy\_keys\_path](#input\_deploy\_keys\_path) | The path to the auto-generated deploy keys for this repository | `string` | `"./deploy_keys"` | no |
...
| <a name="input_teams"></a> [teams](#input\_teams) | The list of collaborators (teams) of the repository | `map(string)` | `{}` | no |
...
| <a name="input_users"></a> [users](#input\_users) | The list of collaborators (users) of the repository | `map(string)` | `{}` | no |
