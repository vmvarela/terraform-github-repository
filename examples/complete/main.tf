module "github" {
  ...
  advanced_security                       = try(each.value.advanced_security, try(local.defaults.advanced_security, null))
  secret_scanning                         = try(each.value.secret_scanning, try(local.defaults.secret_scanning, null))
